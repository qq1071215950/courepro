  ...
  export default {
    ...
    methods: {
      ...
      list(page) {
        let _this = this;
        Loading.show();
        _this.$ajax.post(process.env.VUE_APP_SERVER + '/business/course/list', {
          page: page,
      ...
      allCategory() {
        let _this = this;
        Loading.show();
        _this.$ajax.post(process.env.VUE_APP_SERVER + '/business/category/all').then((response)=>{
          Loading.hide();
          let resp = response.data;
      ...
      allTeacher() {
        let _this = this;
        Loading.show();
        _this.$ajax.post(process.env.VUE_APP_SERVER + '/business/teacher/all').then((response)=>{
          Loading.hide();
          let resp = response.data;
      ...
      del(id) {
        ...
        Confirm.show("删除课程后不可恢复，确认删除？", function () {
          Loading.show();
          _this.$ajax.delete(process.env.VUE_APP_SERVER + '/business/course/delete/' + id).then((response)=>{
            Loading.hide();
            let resp = response.data;
            if (resp.success) {
              _this.list(1);
